...
<form action="{{route('backend.updateProduct',$product->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input value="{{$product->name}}" type="name" class="form-control" id="name" placeholder="Enter your product name" name="product_name" required>
      </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input value="{{$product->description}}" type="text" class="form-control" id="date" name="product_description">
      </div>

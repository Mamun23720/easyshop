        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 char_col">
                    <a href="#">
                        <div style="background: #cd7a7a; border-radius: 10px; height: 300px; width: 280px;"
                            class="char_item d-flex flex-row align-items-center justify-content-start">
                            <div class="char_content">
                                <div class="char_title ml-4"><b>
                ...
                <div class="col-lg-3 col-md-6 char_col">
                    <a href="#">
                        <div style="background: #8a59e5; border-radius: 10px; height: 300px; width: 280px;"
                            class="char_item d-flex flex-row align-items-center justify-content-start">
                            <div class="char_content">
                                <div class="char_title ml-5"><b>
                                        <h4>Cosmetics</h4>
                                    </b></div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 char_col">
                    <a href="#">
                        <div style="background: #6eed96; border-radius: 10px; height: 300px; width: 280px;"
                            class="char_item d-flex flex-row align-items-center justify-content-start">
                            <div class="char_content">
                                <div class="char_title ml-5"><b>
                                        <h4>Smartphones</h4>
                ...
                <div class="col-lg-3 col-md-6 char_col">
                    <a href="#">
                        <div style="background: #ff8a43; border-radius: 10px; height: 300px; width: 280px;"
                            class="char_item d-flex flex-row align-items-center justify-content-start">
                            <div class="char_content">
                                <div class="char_title ml-5"><b>
                                        <h4>Jewellerys</h4>

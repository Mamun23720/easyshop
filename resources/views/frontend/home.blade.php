...
@section('content')
            ...
            @foreach ($allBanner as $index => $banner)
                <div class="slide {{ $loop->first ? 'active' : '' }}">
                    ...
                    <div class="slider-content">
                        ...
                        <a style="color: white; background-color: #0e8ce4" class="button button3 btn-lg mt-5"
                            href="{{ route('frontend.product') }}"><b>Shop Now</b></a>
                    </div>
                </div>
            @endforeach
        </div>
                        ...
                        <div class="details">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <p
                                        style="font-size: 18px; width: 140px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;">
                                        <b> {{ $product->name }}</b></p>
                                    <p style="font-size: 16px; color: red; width: 140px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; "
                                        class="price">৳{{ number_format($product->price, 2) }} <span
                                            style="font-size: 12px; color:black;">-{{ $product->discount }}%</span></p>

                                </div>

                                <div style="padding-right: 0px;" class="col mt-2">
                                    <a style="height: 50px; width: 50px; border-radius:50%; padding: 5px 0px;"
                                        class="button button2" href="{{ route('add.to.cart', $product->id) }}"><i
                                            style="font-size: 28px;" class="bi bi-cart4"></i></a>
                                </div>
        ...
        <div class="container-fluid mt-3">
            <div style="display: flex; flex-wrap: wrap; gap: 23px; justify-content:center;" class="row">
                ...
                @foreach ($allCategory as $category)
                    <div style="display: flex; justify-content: center; align-items: center; max-width: 8.5%"
                        class="col">
        ...
        <div style="justify-content:center;" class="row mt-3">
            ...
            <div class="col">
                ...
                <div class="image">
                    ...
                    <img style="height: 280px; width: 600px; border: 5px solid white; filter: brightness(30%); "
                        src="{{ url('/uploads/important/image.png') }}" alt="">
                    <div class="image-content">
                        <h3>New Offer</h3><br>
                        <a style="color: white; background-color: #0e8ce4; height:42px;" class="button button3 btn-lg mt-0"
                            href="{{ route('frontend.product') }}"><b>Shop Now</b></a>
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="image">
                    ...
                    <div class="image-content">
                        <h3>Top Offer</h3><br>
                        <a style="color: white; background-color: #0e8ce4; height:42px;"
                            class="button button3 btn-lg mt-0" href="{{ route('frontend.product') }}"><b>Shop Now</b></a>
                    </div>
                </div>
                    ...
                    <div class="image-container">
                        ...
                        <a href="{{ route('show.product', $product->id) }}">
                            <img style="height: 230px; width: 100%;"
                                src="{{ url('/uploads/product/' . $product->image) }}" alt="{{ $product->name }}" />
                        ...
                        <div class="details">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <p style="font-size: 16px; color: red; width: 140px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; "
                                        class="price">৳{{ number_format($product->price, 2) }} <span
                                            style="color:black; font-size: 12px;">-{{ $product->discount }}%</span></p>
    ...
    <!-- newsletter -->
        ...
        <div style="padding-left: 100px; padding-right: 100px; padding: 50px" class="container mt-1">
            <div class="row">
                <div class="col">
                    <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                        <div class="newsletter_title_container">
                            <div class="newsletter_icon"><svg xmlns="http://www.w3.org/2000/svg" width="50"
                                    height="50" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16">
                                    <path
                                        d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z" />
                                </svg></div>
                            <div class="newsletter_title"><b>Sign up for Newsletter</b></div>
                            <div class="newsletter_text">
                                <p>...and receive %20 coupon for your first shopping.</p>
                            </div>
                        </div>
                        <div class="newsletter_content clearfix">
                            <form action="#" class="newsletter_form">
                                <input type="email" class="newsletter_input" placeholder="Enter your email address"
                                    required>
                                <button class="newsletter_button"><b>Subscribe</b></button>
                            </form>
                        </div>
                    </div>
                </div>

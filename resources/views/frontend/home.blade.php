...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col">
            <a href="#">
                <div style="background: #4160ff; height: 200px; width: 200px; gap: 5px; " class="category-box d-flex align-items-center justify-content-center">
                    <img class="category-image" style="height: 190px; width: 190px; border-radius: 50%; " src="{{ url('/uploads/category/' . $category->image) }}" alt="{{$category->name}}">
...
<div class="container-fluid mt-5">
    ...
    <div class="product-grid">
        ...
        <div style="height: 350px; width: 250px;  border-radius:5%" class="product-card">
            <img style="height: 230px; width: 100%;" src="{{ url('/uploads/product/' . $product->image) }}" alt="{{ $product->name }}">
            <div class="details">
                <h2>{{ $product->name }}</h2>

            ...
            <div class="row gx-5">
                <aside class="col-lg-6">
                    <div style="text-align: center" class="mb-3 d-flex">
                        <img style="height: 500px; width: 500px" class="border rounded-5 bg-white"
                            src="{{ url('/uploads/product/' . $singleProduct->image) }}" />
                    </div>
                    <div>
                        <a style="margin-left: 180px" class="btn btn-primary mt-1" href="#"
                ...
                <main class="col-lg-6">
                    ...
                    <div class="ps-lg-3">
                        ...
                        <h4 class="title text-dark"><b>Product Name: {{ $singleProduct->name }}</b></h4>
                        ...
                        <div>
                            <a style="margin-right: 5px" class="btn btn-success mt-5"
                                href="{{ route('buy.now', $singleProduct->id) }}" class="nav-link">Buy Now</a>
                            <a style="margin-right: 5px" class="btn btn-warning mt-5"
                                href="{{ route('add.to.cart', $singleProduct->id) }}" class="nav-link">Add to Cart</a>
                        </div>
                        {{--
            <div class="row">
                    ...
                    <div class="col-md-3" style="height: 340px; width: 252px">
                        <div class="card h-100 mb-0">
                            ...
                            <div class="card-footer pt-0 border-top-0 bg-transparent mt-0">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#"><b>View
                                            Details</b></a></div>
                            </div>
                        </div>
                    </div>
